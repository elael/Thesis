...
function's range stand for fullness or emptyness of a point.
...
cardinality of the continuum } to be tractable by exaustion even considering
...
conditional independece of spatial points and discretize the space even further,
...
using laser sensors~\cite{gan20093d}.\footnote{$\Phi(x)=\frac{1}{\sqrt{2\pi}}\displaystyle\int_{-\infty}^x \e^{-\nicefrac{t^2}{2}}dt$}
