...
Here $\theta_s$ is the angle between the reflected direction being considered
and the specular direction and $\nu$ a shininess constant describing how
concetrated the specular reflection is. In the limit of $\nu \to \inf$ it
