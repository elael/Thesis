...
the water surface from within\cite{LURTON,Etter2013}. The other extreme case is
the perfect diffuse reflection (usually called scatter in acoustics), where a
rough surface reflects same perceived energy (radiance) in all directions, thus
following a cosine law (Lambert's Cossine Law) with respect to the incident and
reflected(scattered) angles \cite{united1977geometrical,cox2004acoustic}:
...
the surface normal for the incident and reflected rays, respetively.
...
Most of the methods applied to audio were developped for computer graphics
...
This method focus on environments composed by segments on the 2D case or slices
of planes on the 3D case. It works best on box like environments, for this
creates a perfect tiling of space\cite{funkhouser2003survey}.

For each reflective surface, a virtual source is created on the 
